    ...
    BootstrapSwitch = (function() {
      function BootstrapSwitch(element, options) {
        ...
        this.options = $.extend({}, $.fn.bootstrapSwitch.defaults, {
          ...
          sizeSwitch: this.$element.data("sizeSwitch"),
          marginLeft: this.$element.data("marginLeft"),
      ...
      BootstrapSwitch.prototype.sizeSwitch = function(value) {
        if (typeof value === "undefined") {
          return this.options.sizeSwitch;
        }
        this.options.sizeSwitch = value;
        this._width();
        this._containerPosition();
        return this.$element;
      };

      BootstrapSwitch.prototype.marginLeft = function(value) {
        if (typeof value === "undefined") {
      ...
      BootstrapSwitch.prototype._width = function() {
        ...
        this._sizeSwitch = this.options.sizeSwitch;
        this.$container.width(/*(this._handleWidth * 2) + this._labelWidth*/ "270px");
        return this.$wrapper.width(this._sizeSwitch);
      };
      ...
      BootstrapSwitch.prototype._containerPosition = function(state, callback) {
        ...
        this.$container.css("margin-left", (function(_this) {
          return function() {
            var values;
            values = [0, "-" + _this.options.marginLeft ];
            if (_this.options.indeterminate) {
